            ...
            if system_prompt:
                ...
                if "customer care agent" in system_prompt.lower():
                    customer_care_instructions = (
                        ...
                        "Warranty questions are informational in this demo. Do not offer complaint "
                        "ticket creation only because warranty is active. If the customer asks about "
                        "warranty status, policy, delivery age, or general eligibility, set "
